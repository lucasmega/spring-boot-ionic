package com.lucasmega.cursomc.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> dataEntegrityException(ObjectNotFoundException e, HttpServletRequest request) {
