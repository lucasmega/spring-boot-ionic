...
import com.lucasmega.cursomc.domain.Estado;
import com.lucasmega.cursomc.domain.ItemPedido;
import com.lucasmega.cursomc.domain.Pagamento;
import com.lucasmega.cursomc.domain.PagamentoComBoleto;
import com.lucasmega.cursomc.domain.PagamentoComCartao;
import com.lucasmega.cursomc.domain.Pedido;
import com.lucasmega.cursomc.domain.Produto;
...
import com.lucasmega.cursomc.repositories.CidadeRepository;
import com.lucasmega.cursomc.repositories.ClienteRepository;
import com.lucasmega.cursomc.repositories.EnderecoRepository;
import com.lucasmega.cursomc.repositories.EstadoRepository;
...
import com.lucasmega.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Produto p11 = new Produto(null, "Shampo", 80.00);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "lucas.mega07@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("!Lm426367"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838340"));
		
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "lucas8514@hotmail.com", "34403364098", TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("!Lm426367"));
		cli1.getTelefones().addAll(Arrays.asList("27363311", "93838393"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012",  cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "04852050",  cli2, c2);
